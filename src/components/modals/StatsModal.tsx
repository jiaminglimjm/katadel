    ...
    >
      ...
      <div>
        <div className="mt-5 sm:mt-6 columns-2 dark:text-white">
          ...
          <button
            type="button"
            className="mt-2 w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text"
            onClick={() => {
              shareStatus(
                solution,
                guesses,
